# Action 16 — hover（水中懸停）

> 情境：**水下**｜循環
> 搭配 `character_reference.png` 與 `docs/spec/rules_bangui_v3.6.md` 一起使用。
> 產出一張 **3 × 4** 的圖，存成 `reference/sheets/bangui/action_16_hover.png`。
...
DESCRIPTION:
Staying in one place in mid-water with small, lazy paddling.
