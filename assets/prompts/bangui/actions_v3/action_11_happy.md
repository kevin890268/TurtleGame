# Action 11 — happy（開心（搖屁屁））

> 情境：**水上**｜循環
> 搭配 `character_reference.png` 與 `docs/spec/rules_bangui_v3.6.md` 一起使用。
> 產出一張 **3 × 4** 的圖，存成 `reference/sheets/bangui/action_11_happy.png`。
...
DESCRIPTION:
A happy little wiggle: the rear of the body sways from side to side while the front stays planted.
...
This is the best view for this action: the swaying rear and swinging tail face the viewer.
