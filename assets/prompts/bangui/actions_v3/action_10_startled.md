# Action 10 — startled（嚇一跳）

> 情境：**水上**｜單次
> 搭配 `character_reference.png` 與 `docs/spec/rules_bangui_v3.6.md` 一起使用。
> 產出一張 **3 × 4** 的圖，存成 `reference/sheets/bangui/action_10_startled.png`。
...
DESCRIPTION:
A harmless surprise: the head jerks back, then the turtle calms down.
