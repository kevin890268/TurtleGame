...
- [x] **多品種**：斑龜、麝香龜、地圖龜、錦龜、巴西龜（收容），共 5 種；每個品種的體型、代謝、水質耐受度、游泳能力、曬背和水底活動的習性都不同（`js/species.js`）
...
巴西龜的提示詞已經備好，還沒生圖（遊戲裡用程式畫的替代圖）。剃刀龜、條紋動胸龜、歐洲澤龜、東部長頸龜的提示詞也備好了，還沒生圖也還沒登記進遊戲。
