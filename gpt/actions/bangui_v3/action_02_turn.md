...
> 產出一張 **3 × 4** 的圖，存成 `reference/sheets/bangui/action_02_turn.png`。
...
DESCRIPTION:
The whole turtle turns about 90 degrees toward its own left, stepping in place.
...
IMPORTANT:
Do NOT rotate only the head. The shell, legs and tail rotate together as one rigid body.
