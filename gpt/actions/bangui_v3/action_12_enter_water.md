# Action 12 — enter_water（下水）

> 情境：**水上**｜單次
> 搭配 `character_reference.png` 與 `gpt/rules/rules_bangui_v3.6.md` 一起使用。
> 產出一張 **3 × 4** 的圖，存成 `reference/sheets/bangui/action_12_enter_water.png`。
...
DESCRIPTION:
From the edge of land, the turtle slides forward into the water. Water is NOT drawn.
