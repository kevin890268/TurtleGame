...
> 產出一張 **3 × 4** 的圖，存成 `reference/sheets/bangui/action_07_sleep.png`。
...
DESCRIPTION:
Sleeping on land: plastron on the ground, head partly withdrawn, eyes closed. A slow breathing loop.
