...
> 產出一張 **3 × 4** 的圖，存成 `reference/sheets/bangui/action_17_dive.png`。
...
DESCRIPTION:
From level swimming the turtle points its nose down and dives.
...
The top of the shell turns toward the camera as the nose points down.
...
The plastron and hind legs turn toward the camera as the rear rises.
